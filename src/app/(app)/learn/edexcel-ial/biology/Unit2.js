export const BIOLOGY_UNIT_2_CONTENT = `
...
* Historical Context:  
  * Thalidomide Case: A sleeping pill caused birth defects in thousands of babies because it wasn’t tested on pregnant women.  
  * William Withering’s Digitalis Soup: Developed a remedy for dropsy (oedema) using foxglove and digitalis. Through trial and error, he found the optimal dosage, which is now determined by starting with small doses and gradually increasing them.  
...
* Ensuring Reliability:  
  * Placebo Group: Used to compare the drug’s effectiveness against the placebo effect.  
