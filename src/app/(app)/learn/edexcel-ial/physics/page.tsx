...
import { PHYSICS_UNIT_1_CONTENT } from './Unit1.js';
import { PHYSICS_UNIT_2_CONTENT } from './Unit2.js';
import { PHYSICS_UNIT_3_CONTENT } from './Unit3.js';
import { PHYSICS_UNIT_4_CONTENT } from './Unit4.js';
import { PHYSICS_UNIT_5_CONTENT } from './Unit5.js';
import { PHYSICS_UNIT_6_CONTENT } from './Unit6.js';
...
const UNIT_NOTES_CONTENT: UnitContent = {
    1: PHYSICS_UNIT_1_CONTENT,
    2: PHYSICS_UNIT_2_CONTENT,
    3: PHYSICS_UNIT_3_CONTENT,
    4: PHYSICS_UNIT_4_CONTENT,
    5: PHYSICS_UNIT_5_CONTENT,
    6: PHYSICS_UNIT_6_CONTENT,
};


const revisionTools = [
    { id: 'past-papers', titleTop: 'Physics', titleBottom: 'Past Papers', icon: FileText },
...
const App: React.FC = () => {
    ...
    const DetailsContent = () => (
        <div className="p-6 bg-white rounded-xl shadow-sm">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Physics IAL Details</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
                The Edexcel International Advanced Level (IAL) Physics is a globally recognized qualification, equivalent to A-levels in the UK. It's designed for students who wish to progress to higher education. For Physics, there are comprehensive revision notes, factsheets, questions from past exam papers separated by topic, and other worksheets to aid your learning.
            </p>
            <p className="text-gray-700 leading-relaxed">
                Our platform provides a structured approach to your Physics IAL revision, offering AI-powered mock tests, detailed solutions, and access to AI teachers and private tutors for personalized support. Prepare effectively and achieve your best results!
            </p>
        </div>
    );
    ...
    const TimetableContent = () => (
        <div className="p-6 bg-white rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 mb-4">
                Here you can find the provisional and final timetables for upcoming Edexcel IAL Physics examinations. Please check regularly for updates.
            </p>
    ...
    const FindTutorContent = () => (
        <div className="p-6 bg-white rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 mb-4">
                Need personalized help? Our platform connects you with experienced private tutors specializing in Edexcel IAL Physics.
            </p>
    ...
    const fetchAndDisplayNote = useCallback((unitIndex: number, sectionIdToScrollTo: string | null = null) => {
        ...
        if (markdownText) {
            ...
            if (h1Token && isTextToken(h1Token)) {
                ...
                headingTitle = `${unitName}: Physics Notes`;
            }
        } else {
            headingTitle = `${unitName}: Physics Notes`;
        }
    ...
    const ContinueLessonButton: React.FC = () => {
        return (
            <div id="continue-lesson-button" className="continue-lesson-card flex items-center justify-center" style={{ width: 150, height: 150 }}>
                <i className="fas fa-atom text-6xl text-[#4081ff]" />
            </div>
        );
    };
                                ...
                                <div className="rounded-2xl p-2">
                                    <div className="flex flex-col md:flex-row items-stretch md:items-center gap-6 mb-6">
                                        ...
                                        <div className="flex flex-col flex-grow title-buttons-container">
                                            ...
                                            <p  className="text-gray-700 text-lg mb-10 max-w-3xl">Welcome to the Physics Revision Zone!<br></br>You can use the extensive resources below to prepare for your exams.</p>
                                        </div>
                                    </div>
