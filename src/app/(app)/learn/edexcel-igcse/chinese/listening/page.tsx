...
const App: React.FC = () => {
    ...
    const generateContent = async () => {
        ...
        const prompt = `
            Generate a short IGCSE Chinese listening passage (around 150-250 characters) and at least 7 diverse listening comprehension questions based on it. The topic should be: ${randomTopic}.
            The questions should cover the types found in IGCSE Chinese listening exams, such as:
            ...
            Provide the output as a single JSON object with the following structure. Note that the questions below are samples for each question type, do not use same content of questions. Generate 7 questions that includes each question type. The topic should be: ${randomTopic}.
            {
                "listening_test": {
    ...
    return (
        <div id="main-center-wrapper">
            <div id="igcseTool" className="igcse-tool-container">
                ...
                <style>
                    {`
                    /* Center the tool container using a flex wrapper */
