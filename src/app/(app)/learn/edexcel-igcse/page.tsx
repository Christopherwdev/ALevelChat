    ...
    <div className="min-h-screen bg-white p-0  font-inter">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 rounded-sm pt-20">
       ...
       Edexcel IGCSE <span className="font-medium text-[black]">Revision</span>
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center justify-between hidden">
          Revision Tools
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 hidden">
