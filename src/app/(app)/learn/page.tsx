...
const exams: Array<ExamCardProps> = [
  {
    ...
    buttonClassNames: 'bg-[#ff3b30] hover:shadow-lg hover:shadow-red-500',
  ...
  },
  {
    ...
    buttonText: 'Start Revision',
    buttonClassNames: 'bg-amber-500 hover:shadow-lg hover:shadow-amber-500',
  ...
  },
  {
    ...
    buttonText: 'Start Revision',
    buttonClassNames: 'bg-blue-500 hover:shadow-lg hover:shadow-blue-500',
