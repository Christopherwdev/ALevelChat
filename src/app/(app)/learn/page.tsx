            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`flex items-center justify-between px-6 py-3 rounded-full text-white mb-2 font-bold text-xl transition-all duration-200 ${exam.buttonColor} w-full`}
                >
                  {exam.buttonText}
                  <svg
            ...
            <div key={`${exam.id}-subjects-column`} className="flex flex-col items-center gap-4">
              {exam.subjects.map((subject) => (
                <button
                  ...
                  className="bg-white px-0 py-3 rounded-2xl text-xl text-black font-semibold border-[#00000015] border-2 transition-colors duration-200 text-center w-[95%]"
                >
                  {subject}
                </button>
              ))}
      ...
      <div className="min-h-screen bg-gray-100 p-8 font-inter">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-6">
            {exam.title} - {selectedSubject.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
          </h1>
          <p className="text-gray-700 text-lg">
            This is the detail page for the {selectedSubject.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')} subject under the {exam.title} exam.
